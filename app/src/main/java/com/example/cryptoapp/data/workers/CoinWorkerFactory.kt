...
class CoinWorkerFactory @Inject constructor(
	...
	override fun createWorker(
		...
		return when (workerClassName) {
			RefreshDataWorker::class.qualifiedName -> workerProviders[RefreshDataWorker::class.java]!!.get()
				.create(appContext, workerParameters)
			else -> throw java.lang.RuntimeException("Unknown worker class name $workerClassName")
		}
	}
}